...
public class SwaggerConfig extends WebMvcConfigurationSupport {
  ...
  public Docket apiDocumentation() {
    ...
    return new
        ...
        .select()
        .apis(RequestHandlerSelectors.basePackage("hive.feed"))
        .build()
  ...
  private ApiInfo metaData() {
    return new
        ApiInfoBuilder()
        .title("たまごっち API - Tamagotchi endpoints")
        .description("\"Hive Application Feed API\""
            + "\n Repository: https://github.com/hex-g/tamagotchi"
